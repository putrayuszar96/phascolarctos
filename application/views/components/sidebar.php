            ...
            <div class="nav">
                ...
                <div class="collapse" id="menu-gudang" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="#">Gudang Langsa</a>
                    </nav>
                </div>
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menu-rak" aria-expanded="false" aria-controls="collapseLayouts">
                ...
                <div class="collapse" id="menu-rak" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="#">Rak Cabang</a>
                        <a class="nav-link" href="#">Pengaturan Rak</a>
                    </nav>
                </div>
